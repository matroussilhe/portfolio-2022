...
export const theme = getTheme({
  ...
  colors: {
    ...
    "primary-500": palette["grayscale-600"],
    ...
    modes: {
      dark: {
        ...
        "secondary-500": palette["grayscale-300"],
        "secondary-200": palette["grayscale-300"],
        "background": palette["grayscale-700"],
        "surface": palette["brown-700"],
        "on-primary-700": palette["grayscale-900"],
        "on-primary-500": palette["grayscale-900"],
        ...
        "on-surface": palette["grayscale-0"],
      },
    },
  },
